...
```bash {1-2} collapse={1-5, 12-14} title="/etc/ssh/sshd_config"
# ... resto do código
...
Instale o EPEL e em seguida o Fail2Ban:

```bash
dnf install vim epel-release -y
...
Edite o arquivo /root/.ssh/authorized_keys e apague tudo antes de `ssh-rsa`.
